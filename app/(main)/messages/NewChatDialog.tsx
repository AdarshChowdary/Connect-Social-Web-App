    ...
    <Dialog open onOpenChange={onOpenChange}>
      <DialogContent className="bg-card p-0">
        <DialogHeader className="px-6 pt-6">
          ...
          <DialogDescription>This is a group chat.</DialogDescription>
        </DialogHeader>
        <div>
...
function UserResult({ selected, user, onClick }: UserResultProps) {
  return (
    <button
...
function SelectedUserTag({ user, onRemove }: SelectedUserTagProps) {
  return (
    <button
      onClick={onRemove}
      className="flex items-center gap-2 rounded-lg border p-1 hover:bg-muted/50"
    >
